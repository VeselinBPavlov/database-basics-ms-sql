...
CREATE DATABASE Orders ON PRIMARY
   ( NAME = N'Orders_Data', FILENAME = N'D:\Courses\Data\Orders_Data.mdf' , SIZE = 167872KB , MAXSIZE = UNLIMITED, FILEGROWTH = 16384KB )
LOG ON
   ( NAME = N'Orders_Log', FILENAME = N'D:\Courses\Data\Orders_Log.ldf' , SIZE = 2048KB , MAXSIZE = 2048GB , FILEGROWTH = 16384KB )
